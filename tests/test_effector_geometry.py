...
def _home() -> EffectorOrientation:
    return EffectorOrientation(yaw_deg=0.0, pitch_deg=0.0)
...
def test_tilt_clamped_to_90_after_pitch_correction() -> None:
    orientation = EffectorOrientation(yaw_deg=0.0, pitch_deg=-45.0)
